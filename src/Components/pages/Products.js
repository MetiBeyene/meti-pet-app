  ...
  return (
    ...
    <div className='form-content-right'>
      <form
        ...
        <label className='form-label' for="avatar">Select image:</label>
        <input type="file"
        ...
        <div className='form-inputs'>
          ...
          <input type="radio" id="yes" name="Hypoallargenic" value="yes" className='form-input'></input>
          <label for="yes">Yes</label>
          <input type="radio" id="no" name="Hypoallargenic" value="no" className='form-input'></input>
